...
public class Extra3 {
    ...
    public static void main(String[] args) {
        ...
        Cliente cliente1 = new Cliente("Jose", "Fernandez", 38972839, "jfer@gmail.com", "Armesti 3020", 42600015);
        Vehiculo vehiculo1 = new Vehiculo("Ford", "Jupiter", 2018, 48293, "Original", "Rojo", TipoVehiculo.CAMIONETA);
        Cuota cuota1 = new Cuota(1, 100000, new Date(), TipoPago.EFECTIVO);
        Poliza poliza1 = new Poliza(vehiculo1, cliente1, 1, new Date(), new Date(), cuota1, 12, TipoFormaPago.CUOTAS, 
                1000000, true, 500000, TipoCobertura.TOTAL);
